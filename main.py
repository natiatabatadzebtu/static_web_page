...
host = host_arguments(subparsers.add_parser("host", help="host static page/s"))
    ...
    match args.command:
        ...
        case "host":
            if args.website_configuration:
              set_bucket_website_policy(s3_client, args.name, args.host_static)
            if args.host_static:
              print(static_web_page_file(s3_client, args.name, args.host_static))
